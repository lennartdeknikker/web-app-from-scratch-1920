...
},{"./img\\missions-header.jpg":[["missions-header.a33b9f7c.jpg","img/missions-header.jpg"],"img/missions-header.jpg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/utils.js":[function(require,module,exports) {
"use strict";
...
exports.showDataFor = showDataFor;
exports.renderElements = renderElements;
exports.renderBannerFor = renderBannerFor;
...
function getDataFor(_x) {
  return _getDataFor.apply(this, arguments);
} // FUNCTION TO OBTAIN DATA & ADD THAT TO THE DOM


function _getDataFor() {
  _getDataFor = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(data) {
    var endpoint, requestOptions, handleResponse, handleJSONResponse, handleTextResponse;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            handleTextResponse = function _ref3(response) {
            ...
            handleJSONResponse = function _ref2(response) {
            ...
            handleResponse = function _ref(response) {
              ...
              if (contentType.includes('application/json')) {
                ...
                throw new Error("Sorry, content-type ".concat(contentType, " is not supported."));
              }
            };
            ...
            return _context.abrupt("return", fetch("".concat(endpoint + data), requestOptions).then(handleResponse).then(function (data) {
              console.log(data);
              return data;
...
function showDataFor(_x2, _x3) {
  return _showDataFor.apply(this, arguments);
} // FUNCTION TO RENDER DOM ELEMENTS FOR GIVEN DATA


function _showDataFor() {
  _showDataFor = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(identifier, parentElement) {
    var childElementType,
        _args2 = arguments;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            childElementType = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : 'li';
            _context2.next = 3;
            return getDataFor(identifier).then(function (data) {
              if (data.length > 1) {
...
function renderElements(parentElement, childElementType, dataToShow) {
  var newNode = document.createElement(childElementType);
  var newContent = document.createTextNode(dataToShow);
...
function renderBannerFor(_x4) {
  return _renderBannerFor.apply(this, arguments);
}

function _renderBannerFor() {
  _renderBannerFor = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return getDataFor("launches/".concat(selector)).then(function (data) {
              document.documentElement.style.setProperty('--banner-background', "url('".concat(data.links.flickr_images[0], "')"));
            });
  ...
  _createClass(Router, [{
    ...
    value: function init() {
      ...
      this.routes.some(function (route) {
        var regEx = new RegExp("^".concat(route.uri));
...
router.init();
(0, _utils.renderBannerFor)('latest');
(0, _utils.showDataFor)('launches/upcoming', '.upcoming-launches');
(0, _utils.showDataFor)('launches/latest', '.latest-launch', 'p');
(0, _utils.showDataFor)('launches/past', '.past-launches');
var timer;

function addToShowcase(_x) {
  return _addToShowcase.apply(this, arguments);
}

function _addToShowcase() {
  _addToShowcase = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(type) {
    var capitalize, newTitle;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            newTitle = "".concat(capitalize(type), " Launch");
            document.querySelector('.showcase-title').innerHTML = newTitle;
            _context.next = 5;
            return (0, _utils.getDataFor)("launches/".concat(type)).then(function (data) {
              var relevantData = {
              ...
              document.querySelectorAll('.next-item').forEach(function (item) {
                return item.remove();
              }); // add patch image
              ...
              var target = document.querySelector('.showcase-image-container');
              target.appendChild(imageElement); // add short info statements

              var shortInfo = [{
                name: 'Mission',
                value: "Nr. ".concat(relevantData.flightNumber, ", ").concat(relevantData.missionTitle)
              }, {
                name: 'Rocket',
              ...
              for (var _i = 0, _shortInfo = shortInfo; _i < _shortInfo.length; _i++) {
                var item = _shortInfo[_i];
                var newSpan = document.createElement('span');
                newSpan.classList.add('info-type');
                var spanText = document.createTextNode(item.name.toUpperCase());
                newSpan.appendChild(spanText);
                var newNode = document.createElement('li');
                var newContent = document.createTextNode(item.value);
                newNode.appendChild(newSpan);
                newNode.appendChild(newContent);
                newNode.classList.add('next-item');

                var _target = document.querySelector('.showcase-titles-container');
              ...
              var detailsText = document.createTextNode(relevantData.details);
              ...
              target.appendChild(detailsElement); // add launch date

              var launchDate = {
                name: 'Launch date',
                value: "".concat(relevantData.launchDate.getDate(), "/").concat(String(relevantData.launchDate.getMonth() + 1).padStart(2, '0'), "/").concat(relevantData.launchDate.getFullYear(), " \n        ").concat(relevantData.launchDate.getHours(), ":").concat(relevantData.launchDate.getMinutes())
              };
              var launchDateElement = document.createElement('p');
              launchDateElement.classList.add('showcase-launchdate-date', 'next-item');
              var launchDateHead = document.createElement('span');
              var launchDateHeadText = document.createTextNode(launchDate.name.toUpperCase());
              launchDateHead.appendChild(launchDateHeadText);
              launchDateHead.classList.add('info-type');
              var launchDateText = document.createTextNode(launchDate.value);
              ...
              target.insertBefore(launchDateElement, target.querySelector('.showcase-launchdate-countdown')); // add video link      

              var videoLink = document.createElement('a');
              var videoLinkText = document.createTextNode(' Click here to watch the video');
...
document.querySelector('#button-past-launches').addEventListener('click', function () {
  addToShowcase('latest');
  makeActive('#button-past-launches');
});
document.querySelector('#button-upcoming-launches').addEventListener('click', function () {
  addToShowcase('next');
  makeActive('#button-upcoming-launches');
});
addToShowcase('next');
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","../styles.css":"styles.css","./utils.js":"js/utils.js","./router.js":"js/router.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
